 ...
 * is stored.
 *
 * Every row except flow control is roamed and read by the terminal page out of
 * the shared-origin prefs doc, so a change reaches the live terminal without a
 * reload.
 */
