...
/**
 * The terminal is scenery here, and it is expensive scenery: mounting a session
 * boots a real xterm, and xterm's `CoreBrowserService` calls `matchMedia`,
 * which jsdom does not ship. So `term.open()` rejects and Vitest fails the FILE
 * on the unhandled rejection while every assertion in it passes.
 *
 * Stubbed, therefore. What the real component does is
