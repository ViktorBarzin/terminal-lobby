...
func TestTmuxAPIRename(t *testing.T) {
	...
	want := `POST /sessions/feat-header/rename vbarzin {"name":"polish-header"}`
	if calls[0] != want {
...
`
	...
	cases := []struct {
		...
		{"wizard", "vbarzin", true},
		{"emo", "emil.barzin", true},
		{"ancamilea", "ancaelena98", true},
