...
def m2():
    ...
    y += 30
    row("cluster-health", "from bob \u00b7 \u27f3 update",
    ...
    s.text(PAD + 34, y + 62, "bob has changed their copy since you installed it.",
           size=11, fill=ACCENT)
    y += 90

    row("caveman", "from bob", [("Remove", "normal"), ("Delete", "danger")],
        on=False, y=y)
    y += 34
