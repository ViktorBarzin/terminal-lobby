...
def m1():
    ...
    row(y, "cluster-health", "from bob · ⟳ update", on=True, metafill=ACCENT); y += 26
    row(y, "caveman", "from bob", on=False); y += 26
    ...
    s.divider(y)
    y += 22
    s.text(PAD, y, "From bob — not installed (8)", size=12, fill=FG, weight="600")
    y += 24
