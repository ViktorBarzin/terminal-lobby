...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 560 266" style="max-width:560px;width:100%;height:auto;display:block" role="img" aria-label="A skill row: actions inline, detail on expand">
  ...
  <text x="335.40000000000003" y="94" font-family="'DM Sans','Inter',system-ui,-apple-system,sans-serif" font-size="11" fill="#4493f8" text-anchor="end">from bob · ⟳ update</text>
  ...
  <text x="52" y="170" font-family="'DM Sans','Inter',system-ui,-apple-system,sans-serif" font-size="11" fill="#4493f8">bob has changed their copy since you installed it.</text>
  ...
  <text x="401.6" y="202" font-family="'DM Sans','Inter',system-ui,-apple-system,sans-serif" font-size="11" fill="#7d8590" text-anchor="end">from bob</text>
