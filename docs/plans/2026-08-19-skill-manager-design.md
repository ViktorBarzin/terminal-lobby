...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 420 674" style="max-width:420px;width:100%;height:auto;display:block" role="img" aria-label="Skills group in the lobby Settings panel">
  ...
  <text x="402" y="234" font-family="'DM Sans','Inter',system-ui,-apple-system,sans-serif" font-size="11" fill="#4493f8" text-anchor="end">from emo · ⟳ update</text>
  ...
  <text x="402" y="260" font-family="'DM Sans','Inter',system-ui,-apple-system,sans-serif" font-size="11" fill="#7d8590" text-anchor="end">from emo</text>
  ...
  <text x="18" y="474" font-family="'DM Sans','Inter',system-ui,-apple-system,sans-serif" font-size="12" fill="#e6e8eb" font-weight="600">From emo — not installed (8)</text>
