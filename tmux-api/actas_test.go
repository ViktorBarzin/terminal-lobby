...
// switch, an as-emo tab would enrol this browser as one of emo's devices and
// keep delivering emo's session notifications here long after the tab closed —
...
// tell "I am emo" from "I am wizard acting as emo" without trusting its own
